...
<head>
  ...
  <meta name="nodejs.org:node-version" content="v20.8.0">
  <title>Console | Node.js v20.8.0 Documentation</title>
    ...
    <div id="column1" data-id="console" class="interior">
      <header class="header">
        <div class="header-container">
          <h1>Node.js v20.8.0 documentation</h1>
        ...
        <div id="gtoc">
          <ul>
            <li class="pinned-header">Node.js v20.8.0</li>
...
<li><a href="https://github.com/nodejs/node" class="nav-https-github-com-nodejs-node">Code repository and issue tracker</a></li>
    ...
    <li class="picker-header">
      ...
      <div class="picker"><ol id="alt-docs"><li><a href="https://nodejs.org/docs/latest-v20.x/api/console.html">20.x</a></li>
...
<p><strong>Source Code:</strong> <a href="https://github.com/nodejs/node/blob/v20.8.0/lib/console.js">lib/console.js</a></p>
